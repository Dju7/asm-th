  ...
  const tabs = [
    ...
    <div className="h-[90%] w-[90%] mt-10 flex flex-col gap-4 lg:gap-6 items-center text-sky-800">
      ...
      <ul className="text-lg   list-disc">
        <li className="lg:mb-2">Recevoir un soin énergétique en profondeur</li>
        <li className="lg:mb-2">Soulager douleurs physiques et psychologiques</li>
        <li className="lg:mb-2">Rebooster sa vitalité et son moral</li>
        <li className="lg:mb-2">Entretien et coaching</li>
      </ul>
      <p className="p-2 text-md lg:text-xl bg-amber-200 border border-sky-500">80€</p>
    </div>
    },
    { label: "A distance", 
    contain: 
    ...
    <ul className="text-lg  list-disc">
      ...
      <p className="p-2 text-md lg:text-xl bg-amber-200 border border-sky-500">70€</p>
    </div>
    },
    { label: "Tarot", 
    contain: 
    ...
    <ul className="text-lg list-disc">
      <li className="lg:mb-2">Interroger un champ de votre vie en particulier</li>
    ...
    <p className="p-2 text-md lg:text-xl bg-amber-200 border border-sky-500">40€</p>
  </div>
    },
  ];
